...
public class OrderPanel extends VBox {
    ...
    public OrderPanel(double width, double height) {
        ...
        selectedLabel.setFont(Font.font("System", FontWeight.BOLD, 15));
        selectedLabel.setTextFill(Color.web("#C8D8FF"));

        priceLabel = new Label("현재가: ─");
        priceLabel.setFont(Font.font("System", 13));
        ...
        qtyHeader.setFont(Font.font("System", FontWeight.BOLD, 12));
        qtyHeader.setTextFill(Color.web("#AAB4D4"));

        qtyField = new TextField("0");
        qtyField.setFont(Font.font("System", FontWeight.BOLD, 16));
        qtyField.setStyle(
